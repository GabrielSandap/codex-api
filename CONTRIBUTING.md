...
3. For CLI/profile/security changes, also run both offline audits with your installed stable Codex CLI (minimum 0.153.4). Explain the actual validation environment.
